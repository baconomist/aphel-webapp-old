...
class CustomNav extends HTMLElement
{
    constructor()
    {
        ...
        this.innerHTML =
            `
            <nav class="navbar navbar-light navbar-expand-lg fixed-top bg-white transparency border-bottom border-light" id="transmenu" style="color:rgb(255,255,255);background-color:#439d4c;">
            ...
            <div class="dropdown-menu" role="menu">
                ...
                <a class="dropdown-item auth-for-post" role="presentation" href="post_announcement.html">
                <i class="fa fa-envelope-open-o" style="padding-right:5px;"></i>Create Announcement
                </a>
                <a class="dropdown-item auth-for-post" role="presentation" href="user_announcements.html">
